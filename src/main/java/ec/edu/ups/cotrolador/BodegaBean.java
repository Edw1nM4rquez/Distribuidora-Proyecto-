...
public class BodegaBean implements Serializable {
    ...
    public String bodegaProductos(Bodega bodegaProductos){
        this.bodgaListar=bodegaProductos;
        return "catalogoBodega?faces-redirect=true";
    }

    public Bodega getBodgaListar() {
        return bodgaListar;
    }

    public void setBodgaListar(Bodega bodgaListar) {
        this.bodgaListar = bodgaListar;
    }
}
